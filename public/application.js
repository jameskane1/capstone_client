...
var config = {
  apiOrigins: {
    ...
    production: 'https://jimmy-kane-capstone-2017.herokuapp.com'
  }
};
...
var submitValues = __webpack_require__(13);
...
var onSignUp = function onSignUp(event) {
  ...
  api.createSignUp(data).then(ui.signUpSuccess).then(function () {
    return api.createSignIn(data);
  }).then(ui.signInSuccess).then(ui.hideOnSignIn).then(ui.showOnSignIn).then(function () {
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createSignIn(data).then(ui.signInSuccess).then(ui.hideOnSignIn).then(ui.showOnSignIn).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).then(function () {
    $('#sign-in-form')[0].reset();
  }).then(function () {
    $('#sign-up-form')[0].reset();
  }).then(function () {
...
var onGetWeatherUnderground = function onGetWeatherUnderground(event) {
  api.getWeatherUnderGround().then(ui.weatherUndergroundSuccess);
};

var onPageLoadWeather = function onPageLoadWeather() {
  api.weatherData().then(ui.showWeatherData).catch(ui.failure);
};

var onPageLoadSport = function onPageLoadSport() {
  api.sportData().then(ui.showSportData).catch(ui.failure);
};

var onPageLoadCeleb = function onPageLoadCeleb() {
  api.celebData().then(ui.showCelebData).catch(ui.failure);
};

var onPageLoadNews = function onPageLoadNews() {
  api.newsData().then(ui.showNewsData).catch(ui.failure);
};

var onChangePassword = function onChangePassword(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.changePassword(data).then(ui.changePasswordSuccess).then(function () {
...
var onSignOut = function onSignOut(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signOut(data).then(ui.signOutSuccess).then(ui.hideOnSignOut).then(ui.showOnSignOut).then(toggleSet).then(function () {
    $('#fullDashboard').empty();
  }).then(function () {
    $('.createWeatherEmpty').val('');
...
var onGetWeatherId = function onGetWeatherId(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getWeatherId(data).then(ui.getWeatherIdSuccess).catch(ui.getWeatherIdFailure);
};

var onGetSportId = function onGetSportId(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getSportId(data).then(ui.getSportIdSuccess).catch(ui.getSportIdFailure);
};

var onGetCelebId = function onGetCelebId(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getCelebId(data).then(ui.getCelebIdSuccess).catch(ui.getCelebIdFailure);
};

var onGetNewsId = function onGetNewsId(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getNewsId(data).then(ui.getNewsIdSuccess).catch(ui.getNewsIdFailure);
};

var onEditWeatherSubmit = function onEditWeatherSubmit(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.editWeather(data).then(ui.editWeatherSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.editWeatherFailure);
};

var onEditSportSubmit = function onEditSportSubmit(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.editSport(data).then(ui.editSportSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.editSportFailure);
};

var onEditCelebSubmit = function onEditCelebSubmit(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.editCeleb(data).then(ui.editCelebSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.editCelebFailure);
};

var onEditNewsSubmit = function onEditNewsSubmit(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.editNews(data).then(ui.editNewsSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.editNewsFailure);
};
...
var onWeatherDelete = function onWeatherDelete(event) {
  event.preventDefault();
  api.deleteWeather().then(ui.deleteWeatherSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.deleteWeatherFailure);
};

var onSportDelete = function onSportDelete(event) {
  event.preventDefault();
  api.deleteSport().then(ui.deleteSportSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.deleteSportFailure);
};

var onCelebDelete = function onCelebDelete(event) {
  event.preventDefault();
  api.deleteCeleb().then(ui.deleteCelebSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.deleteCelebFailure);
};

var onNewsDelete = function onNewsDelete(event) {
  event.preventDefault();
  api.deleteNews().then(ui.deleteNewsSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.deleteNewsFailure);
};

var onWeatherCreate = function onWeatherCreate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createWeather(data).then(ui.createWeatherSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadWeather).then(onPageLoadSport).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.createWeatherFailure);
};

var onSportCreate = function onSportCreate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createSport(data).then(ui.createSportSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadSport).then(onPageLoadWeather).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.createSportFailure);
};

var onCelebCreate = function onCelebCreate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createCeleb(data).then(ui.createCelebSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadSport).then(onPageLoadWeather).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.createCelebFailure);
};

var onNewsCreate = function onNewsCreate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createNews(data).then(ui.createNewsSuccess).then(function () {
    $('#fullDashboard').empty();
  }).then(onPageLoadSport).then(onPageLoadWeather).then(onPageLoadCeleb).then(onPageLoadNews).catch(ui.createNewsFailure);
};
...
var onUndergroundCreate = function onUndergroundCreate(event) {
  var data = getFormFields(this);
  store.underground = data;
  event.preventDefault();
  api.createUnderground(data).then(ui.getUndergroundSuccess).catch(ui.getUndergroundFailure);
};

exports.onUndergroundCreate = onUndergroundCreate;
exports.onSignUp = onSignUp;
exports.onSignIn = onSignIn;
exports.onChangePassword = onChangePassword;
exports.onSignOut = onSignOut;
exports.onPageLoadWeather = onPageLoadWeather;
exports.onEditWeatherSubmit = onEditWeatherSubmit;
exports.onGetWeatherId = onGetWeatherId;
exports.onWeatherDelete = onWeatherDelete;
exports.onWeatherCreate = onWeatherCreate;
exports.onGetSportId = onGetSportId;
exports.onCloseModal = onCloseModal;
exports.onEditSportSubmit = onEditSportSubmit;
exports.onSportDelete = onSportDelete;
exports.onSportCreate = onSportCreate;
exports.onCelebCreate = onCelebCreate;
exports.onGetCelebId = onGetCelebId;
exports.onEditCelebSubmit = onEditCelebSubmit;
exports.onCelebDelete = onCelebDelete;
exports.onNewsCreate = onNewsCreate;
exports.onGetNewsId = onGetNewsId;
exports.onEditNewsSubmit = onEditNewsSubmit;
exports.onNewsDelete = onNewsDelete;
exports.onGetWeatherUnderground = onGetWeatherUnderground;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var createSignUp = function createSignUp(data) {
  return $.ajax({
...
var createSignIn = function createSignIn(data) {
  return $.ajax({
...
var sportData = function sportData() {
  return $.ajax({
...
var celebData = function celebData() {
  return $.ajax({
...
var getWeatherId = function getWeatherId(data) {
  return $.ajax({
...
var getSportId = function getSportId(data) {
  return $.ajax({
...
var getCelebId = function getCelebId(data) {
  return $.ajax({
...
var getNewsId = function getNewsId(data) {
  return $.ajax({
...
var editWeather = function editWeather(data) {
  return $.ajax({
...
var editSport = function editSport(data) {
  return $.ajax({
...
var editCeleb = function editCeleb(data) {
  return $.ajax({
...
var editNews = function editNews(data) {
  return $.ajax({
...
var deleteWeather = function deleteWeather(data) {
  return $.ajax({
    url: config.apiOrigin + '/weathers/' + store.weather1.id,
    method: 'DELETE',
    headers: {
...
var deleteSport = function deleteSport(data) {
  return $.ajax({
    url: config.apiOrigin + '/sports/' + store.sport1.id,
    method: 'DELETE',
    headers: {
...
var deleteCeleb = function deleteCeleb(data) {
  return $.ajax({
    url: config.apiOrigin + '/celebs/' + store.celeb1.id,
    method: 'DELETE',
    headers: {
...
var deleteNews = function deleteNews(data) {
  return $.ajax({
    url: config.apiOrigin + '/news_papers/' + store.news1.id,
    method: 'DELETE',
    headers: {
...
var createWeather = function createWeather(data) {
  return $.ajax({
    url: config.apiOrigin + '/weathers',
    method: 'POST',
    headers: {
...
var createSport = function createSport(data) {
  return $.ajax({
    url: config.apiOrigin + '/sports',
    method: 'POST',
    headers: {
...
var createCeleb = function createCeleb(data) {
  return $.ajax({
    url: config.apiOrigin + '/celebs',
    method: 'POST',
    headers: {
...
var getWeatherUnderGround = function getWeatherUnderGround(data) {
  return $.ajax({
...
var createUnderground = function createUnderground(data) {
  return $.ajax({
...
module.exports = {
  createUnderground: createUnderground,
  ...
  getWeatherUnderGround: getWeatherUnderGround
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var store = __webpack_require__(4);
var showWeathersTemplate = __webpack_require__(17);
var showSportsTemplate = __webpack_require__(34);
var showCelebTemplate = __webpack_require__(35);
var showNewsTemplate = __webpack_require__(36);
var showUndergroundTemplate = __webpack_require__(37);
...
var showWeatherData = function showWeatherData(data) {
  var showPlaysHtml = showWeathersTemplate({ weathers: data.weathers });
  store.weathers = data.weathers;
  $('#fullDashboard').append(showPlaysHtml);
};

var showSportData = function showSportData(data) {
  var showSportHtml = showSportsTemplate({ sports: data.sports });
  $('#fullDashboard').append(showSportHtml);
};

var showCelebData = function showCelebData(data) {
  var showCelebHtml = showCelebTemplate({ celebs: data.celebs });
  $('#fullDashboard').append(showCelebHtml);
};

var showNewsData = function showNewsData(data) {
  var showNewsHtml = showNewsTemplate({ news_papers: data.news_papers });
...
var hideOnSignIn = function hideOnSignIn() {
  $('#sign-in-button').addClass('hide');
  $('#sign-up-button').addClass('hide');
...
var hideOnSignOut = function hideOnSignOut() {
...
var showOnSignIn = function showOnSignIn() {
...
var showOnSignOut = function showOnSignOut() {
  $('#sign-in-button').removeClass('hide');
  $('#sign-up-button').removeClass('hide');
...
var getWeatherIdSuccess = function getWeatherIdSuccess(data) {
...
var getSportIdSuccess = function getSportIdSuccess(data) {
...
var getCelebIdSuccess = function getCelebIdSuccess(data) {
...
var getNewsIdSuccess = function getNewsIdSuccess(data) {
...
var getWeatherIdFailure = function getWeatherIdFailure(error) {
...
exports.hideOnSignIn = hideOnSignIn;
exports.hideOnSignOut = hideOnSignOut;
exports.showOnSignIn = showOnSignIn;
exports.showOnSignOut = showOnSignOut;
...
exports.showSportData = showSportData;
exports.showCelebData = showCelebData;
exports.showNewsData = showNewsData;
exports.editWeatherSuccess = editWeatherSuccess;
exports.getWeatherIdSuccess = getWeatherIdSuccess;
exports.deleteWeatherSuccess = deleteWeatherSuccess;
exports.createWeatherSuccess = createWeatherSuccess;
exports.createWeatherFailure = createWeatherFailure;
exports.getWeatherIdFailure = getWeatherIdFailure;
exports.getSportIdSuccess = getSportIdSuccess;
exports.editSportSuccess = editSportSuccess;
exports.deleteWeatherFailure = deleteWeatherFailure;
exports.deleteSportSuccess = deleteSportSuccess;
exports.deleteSportFailure = deleteSportFailure;
exports.getSportIdFailure = getSportIdFailure;
exports.createSportSuccess = createSportSuccess;
exports.createSportFailure = createSportFailure;
exports.createCelebSuccess = createCelebSuccess;
exports.createCelebFailure = createCelebFailure;
exports.getCelebIdSuccess = getCelebIdSuccess;
exports.getCelebIdFailure = getCelebIdFailure;
exports.editCelebSuccess = editCelebSuccess;
exports.editCelebFailure = editCelebFailure;
exports.editSportFailure = editSportFailure;
exports.editWeatherFailure = editWeatherFailure;
exports.deleteCelebSuccess = deleteCelebSuccess;
exports.deleteCelebFailure = deleteCelebFailure;
exports.createNewsFailure = createNewsFailure;
exports.createNewsSuccess = createNewsSuccess;
exports.getNewsIdFailure = getNewsIdFailure;
exports.getNewsIdSuccess = getNewsIdSuccess;
exports.editNewsSuccess = editNewsSuccess;
exports.editNewsFailure = editNewsFailure;
exports.deleteNewsSuccess = deleteNewsSuccess;
exports.deleteNewsFailure = deleteNewsFailure;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div class=\"col-xs-8 col-md-8 minibox weather\" id='weatherTransition'>\n  <h5>Category: Weather</h5>\n    <div><img id='weatherImage' src='https://cdn1.iconfinder.com/data/icons/weather-elements/128/Weather_CloudSunRAin.png'></div>\n  <p data-id=\""
    ...
    + "\"> State: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.state : stack1), depth0))
    + "</p>\n  <p> &nbsp;<a id='weatherLink' target=”_blank” href='http://www.google.com/search?q=Weather+in+"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.city : stack1), depth0))
    + "'>Google Search</a>&nbsp; </p>\n  <button data-toggle=\"modal\" data-target=\"#exampleModal\" class='btn-primary weatherEdit'>Edit/Delete</button>\n<button data-toggle=\"modal\" data-target=\"#undergroundModal\" class='btn-primary weatherEdit'>Get Current Weather</button>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.weathers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div class=\"col-xs-8 col-md-8 minibox sport\">\n  <h5>Category: Sports</h5>\n  <div><img id='sportsImage' src='https://pbs.twimg.com/profile_images/686982457145606144/r0zrA1_G.png'></div>\n  <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"> ID: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</p>\n  <p data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.team : stack1), depth0))
    + "</p>\n  <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.league : stack1), depth0))
    + "\"> League: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.league : stack1), depth0))
    + "</p>\n  <p> &nbsp;<a id='sportLink' target=”_blank” href='http://www.google.com/search?q="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.team : stack1), depth0))
    + "'>Google Search</a>&nbsp; </p>\n  <button id='sportButton' data-toggle=\"modal\" data-target=\"#sportsEditModal\" class='btn-primary sportEdit'>Edit/Delete</button>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.sports : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div class=\"col-xs-8 col-md-8 minibox celeb\">\n  <h5>Category: Celebs</h5>\n  <div><img id='celebImage' src='https://pbs.twimg.com/profile_images/656734053148655616/niscY2MG.jpg'></div>\n  <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" > ID: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</p>\n  <p data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.age : stack1), depth0))
    + "</p>\n  <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.occupation : stack1), depth0))
    + "\"> Occupation: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.occupation : stack1), depth0))
    + "</p>\n  <p> &nbsp;<a id='celebLink' target=”_blank” href='http://www.google.com/search?q="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "'>Google Search</a>&nbsp; </p>\n  <button id='celebButton' data-toggle=\"modal\" data-target=\"#celebsEditModal\" class='btn-primary celebEdit'>Edit/Delete</button>\n\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.celebs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <!-- Developers, why are we using data-id and not just id? -->\n<div class=\"col-xs-10 col-md-10 minibox news\">\n  <h5>Category: News</h5>\n  <div><img id='newsImage' src='http://www.endoflifecarewirral.org/images/news-image3.png'></div>\n  <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"> ID: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</p>\n  <p data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</p>\n  <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.region : stack1), depth0))
    + "\"> Region: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.region : stack1), depth0))
    + "</p>\n  <p>  &nbsp;<a id='newsLink' target=”_blank” href='http://www."
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.site : stack1), depth0))
    + "'>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "'s Website</a>&nbsp; </p>\n  <button id='newsButton' data-toggle=\"modal\" data-target=\"#newsEditModal\" class='btn-primary newsEdit'>Edit/Delete</button>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.news_papers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"table-responsive\" id='weatherInfo'>\n  <h4 class=\"centered\">Your Weather Report</h4>\n  <table class=\"table\">\n    <thead>\n      <tr>\n        <th></th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr class=\"info\">\n        <td><h5>Tempurature in F: <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.temp_f : stack1), depth0))
    + "</p></h5></td>\n      </tr>\n      <tr class=\"info\">\n        <td><h5>Feels Like: <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.feelslike_f : stack1), depth0))
    + "</p></h5></td>\n      </tr>\n      <tr class=\"info\">\n        <td><h5>Relative Humidity: <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.relative_humidity : stack1), depth0))
    + "</p></h5></td>\n      </tr>\n      <tr class=\"info\">\n        <td><h5>Wind MPH: <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.wind_mph : stack1), depth0))
    + "</p></h5></td>\n      </tr>\n      <tr class=\"info\">\n        <td><h5>Wind Chill in F: <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.windchill_f : stack1), depth0))
    + "</p></h5></td>\n      </tr>\n      <tr class=\"info\">\n        <td><h5>Precipitation Today in Inches: <p>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.precip_today_in : stack1), depth0))
    + "</p></h5></td>\n      </tr>\n      <tr class=\"info\">\n        <td><h5> &nbsp;<a target=”_blank” href='"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.undergrounds : depth0)) != null ? stack1.forecast_url : stack1), depth0))
    + "'>Link to Forecast</a>&nbsp; </h5></td>\n      </tr>\n    </tbody>\n  </table>\n</div>\n";
},"useData":true});
